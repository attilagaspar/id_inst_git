...
import excel "../../data/raw/regulations/buehler list with names and dates.xlsx", sheet("List_by_Content_(updated)")  clear
...
** amelyik a saria listára mutat azt le kell ellenorizni egyesevel h latjuk e a katalogusban
...
/*
rename prov_id prov_id_
rename kab_id kab_id_
*/
drop kab_id prov_id
...
/* create extra category for regulations not found by ovie */
...
save ../../data/regulations/crosswalk_with_treatment_1123.dta, replace
...
foreach py in 2000 2003 2005 2008 2011 {
	...
	forvalues t=1999/`lastyear' {
		...
		replace treatedby_`py'=1 if cum_treat`t'==1
		replace treatedby_`py'b=1 if cum_treat`t'==1
		replace treatedby_`py'b=1 if cum_treat`py'==1
...
duplicates drop bps_2011, force // drop regions that did not exist under podes2011

save ../../data/regulations/treatment_for_podes_1123.dta, replace
